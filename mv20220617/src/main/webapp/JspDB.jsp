    ...
    <BODY>
        ...
        <% 
            ...
            Statement statement = connection.createStatement(
                ResultSet.TYPE_SCROLL_INSENSITIVE,	//讓ResultSet可以上下移動
            ...
            resultset.last();	//需要配合 ResultSet.TYPE_SCROLL_INSENSITIVE 這個參數才能使用
            int rows = resultset.getRow();
            if(current <= rows){
                resultset.absolute(current);	//需要配合 ResultSet.TYPE_SCROLL_INSENSITIVE 這個參數才能使用
            }    
        %>
